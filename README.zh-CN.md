...
3. 从 [最新 Release](https://github.com/wgd-12138/cc-balance-overlay/releases/latest) 下载 `cc-balance-overlay.exe`。
4. 双击运行 `cc-balance-overlay.exe`。
5. 查看 Windows 系统托盘附近，正常会看到两行余额：
